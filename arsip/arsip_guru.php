...
<head>
    ...
    <title>Arsip Guru - <?php echo htmlspecialchars($nama_guru); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        <div class="page-header">
            <div class="page-header-text">
                ...
                <p>Upload dan kelola file arsip pembelajaran Anda</p>
            </div>
        </div>
        ...
        <div class="stats-row">
            ...
            <div class="stat-card" style="border-left-color: #ffa726;">
                <h3>Folder</h3>
                <div class="number" style="color: #ffa726; font-size: 18px;"><?php echo htmlspecialchars($nama_guru); ?></div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="judul_arsip" required placeholder="Masukkan judul/deskripsi file">
                    </div>
